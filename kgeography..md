...
## JSON dump
json source file kgeography.d..json 
...
``` sh
ABCHOST=localhost
curl --output kgeography.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kgeography.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kgeography.d..json
...
# Dockerfile Kgeography is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Kgeography.d -t Kgeography .
```
