...
## JSON dump
json source file blender.d..json 
...
``` sh
ABCHOST=localhost
curl --output blender.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/blender.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @blender.d..json
...
# Dockerfile blender is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f blender.d -t blender .
```
