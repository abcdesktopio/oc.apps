...
## JSON dump
json source file cudademosuite.d.3.0.json 
...
``` sh
ABCHOST=localhost
curl --output cudademosuite.d.3.0.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/cudademosuite.d.3.0.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @cudademosuite.d.3.0.json
...
# Dockerfile cudademosuite is generated at Mon Sep 18 2023 08:19:36 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=3.0 -f cudademosuite.d -t cudademosuite .
```
