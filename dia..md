...
``` sh
ABCHOST=localhost
curl --output dia.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/dia.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @dia.d..json
...
# Dockerfile Dia is generated at Wed Jan 31 2024 16:43:09 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Dia.d -t Dia .
```
