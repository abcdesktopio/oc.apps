...
## JSON dump
json source file sudoku.d..json 
...
``` sh
ABCHOST=localhost
curl --output sudoku.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sudoku.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @sudoku.d..json
...
# Dockerfile sudoku is generated at Thu Mar 28 2024 15:35:00 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f sudoku.d -t sudoku .
```
