...
## JSON dump
json source file konsolephemeralcontainer.d..json 
...
``` sh
ABCHOST=localhost
curl --output konsolephemeralcontainer.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolephemeralcontainer.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolephemeralcontainer.d..json
...
# Dockerfile konsolephemeralcontainer is generated at Thu Mar 28 2024 15:35:00 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f konsolephemeralcontainer.d -t konsolephemeralcontainer .
```
