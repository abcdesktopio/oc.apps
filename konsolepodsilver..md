...
## JSON dump
json source file konsolepodsilver.d..json 
...
``` sh
ABCHOST=localhost
curl --output konsolepodsilver.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodsilver.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodsilver.d..json
...
# Dockerfile konsolepodsilver is generated at Wed Jan 31 2024 16:43:09 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f konsolepodsilver.d -t konsolepodsilver .
```
