...
## JSON dump
json source file konsole.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output konsole.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsole.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsole.d.main.json
...
# Dockerfile konsole is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f konsole.d -t konsole .
```
