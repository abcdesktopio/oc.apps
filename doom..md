...
``` sh
ABCHOST=localhost
curl --output doom.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/doom.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @doom.d..json
...
# Dockerfile doom is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f doom.d -t doom .
```
