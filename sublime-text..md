...
## JSON dump
json source file sublime-text.d..json 
...
``` sh
ABCHOST=localhost
curl --output sublime-text.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sublime-text.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @sublime-text.d..json
...
# Dockerfile sublime-Text is generated at Thu Mar 28 2024 15:14:04 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f sublime-Text.d -t sublime-Text .
```
