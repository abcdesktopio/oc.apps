...
## JSON dump
json source file konsole.d..json 
...
``` sh
ABCHOST=localhost
curl --output konsole.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsole.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsole.d..json
...
# Dockerfile konsole is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f konsole.d -t konsole .
```
