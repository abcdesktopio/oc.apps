...
## JSON dump
json source file cmd.exe.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output cmd.exe.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/cmd.exe.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @cmd.exe.d.main.json
...
# Dockerfile cmd.exe is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f cmd.exe.d -t cmd.exe .
```
