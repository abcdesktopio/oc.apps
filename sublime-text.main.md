...
## JSON dump
json source file sublime-text.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output sublime-text.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sublime-text.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @sublime-text.d.main.json
...
# Dockerfile sublime-Text is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f sublime-Text.d -t sublime-Text .
```
