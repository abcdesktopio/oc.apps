...
## JSON dump
json source file remmina.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output remmina.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/remmina.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @remmina.d.main.json
...
# Dockerfile remmina is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f remmina.d -t remmina .
```
