...
## JSON dump
json source file filelight.d..json 
...
``` sh
ABCHOST=localhost
curl --output filelight.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/filelight.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @filelight.d..json
...
# Dockerfile filelight is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f filelight.d -t filelight .
```
