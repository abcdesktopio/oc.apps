...
## JSON dump
json source file filelight.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output filelight.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/filelight.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @filelight.d.main.json
...
# Dockerfile filelight is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f filelight.d -t filelight .
```
