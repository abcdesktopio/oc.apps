...
``` sh
ABCHOST=localhost
curl --output edge.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/edge.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @edge.d..json
...
# Dockerfile edge is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f edge.d -t edge .
```
