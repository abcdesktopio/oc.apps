...
## inherite from
[abcdesktopio/oc.template.ubuntu.18.04](../abcdesktopio/oc.template.ubuntu.18.04)
## abcdesktop release
main
## Platforms
linux/amd64
...
## JSON dump
json source file remarkable.d.main.json 
...
``` json
{
    ...
    "template": "abcdesktopio/oc.template.ubuntu.18.04",
...
``` sh
ABCHOST=localhost
curl --output remarkable.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/remarkable.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @remarkable.d.main.json
...
# Dockerfile remarkable is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f remarkable.d -t remarkable .
```
