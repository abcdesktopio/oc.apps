...
``` sh
ABCHOST=localhost
curl --output gimp.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gimp.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gimp.d..json
...
# Dockerfile Gimp is generated at Thu Mar 28 2024 10:54:49 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Gimp.d -t Gimp .
```
