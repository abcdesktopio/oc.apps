...
## JSON dump
json source file gimp.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output gimp.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gimp.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gimp.d.main.json
...
# Dockerfile Gimp is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Gimp.d -t Gimp .
```
