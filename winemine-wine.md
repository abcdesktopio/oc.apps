...
## JSON dump
json source file winemine-wine.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output winemine-wine.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winemine-wine.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winemine-wine.d.main.json
...
# Dockerfile winemine-wine is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f winemine-wine.d -t winemine-wine .
```
