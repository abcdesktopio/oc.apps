...
``` sh
ABCHOST=localhost
curl --output vice.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/vice.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @vice.d..json
...
# Dockerfile vice is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f vice.d -t vice .
```
