...
## JSON dump
json source file cudademosuite.d..json 
...
``` sh
ABCHOST=localhost
curl --output cudademosuite.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/cudademosuite.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @cudademosuite.d..json
...
# Dockerfile cudademosuite is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f cudademosuite.d -t cudademosuite .
```
