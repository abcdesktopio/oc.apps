...
## JSON dump
json source file kdiamond.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output kdiamond.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kdiamond.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kdiamond.d.main.json
...
# Dockerfile kDiamond is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f kDiamond.d -t kDiamond .
```
