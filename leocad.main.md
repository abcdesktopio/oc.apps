...
## JSON dump
json source file leocad.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output leocad.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/leocad.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @leocad.d.main.json
...
# Dockerfile Leocad is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Leocad.d -t Leocad .
```
