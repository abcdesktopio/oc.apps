...
## JSON dump
json source file stress.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output stress.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/stress.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @stress.d.main.json
...
# Dockerfile stress is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f stress.d -t stress .
```
