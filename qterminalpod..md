...
## JSON dump
json source file qterminalpod.d..json 
...
``` sh
ABCHOST=localhost
curl --output qterminalpod.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/qterminalpod.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @qterminalpod.d..json
...
# Dockerfile qterminalpod is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f qterminalpod.d -t qterminalpod .
```
