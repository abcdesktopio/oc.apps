...
## JSON dump
json source file drawio.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output drawio.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/drawio.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @drawio.d.main.json
...
# Dockerfile drawio is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f drawio.d -t drawio .
```
