...
# Dockerfile nvidia-smi is generated at Sat Jun 17 2023 12:40:34 GMT+0000 (Coordinated Universal Time)
#
ARG TAG=dev
FROM abcdesktopio/oc.template.ubuntu.nvidia.22.04:$TAG
USER root
RUN apt-get update && apt-get --no-install-recommends --yes install nvidia-utils-470 && apt-get clean
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y  --no-install-recommends konsole vim breeze-icon-theme sudo && apt-get clean
...
LABEL oc.keyword="nvidia-smi,nvidia,smi"
LABEL oc.cat="development"
LABEL oc.desktopfile="org.kde.konsole.desktop"
LABEL oc.launch="nvidiasmi.konsole"
LABEL oc.template="abcdesktopio/oc.template.ubuntu.nvidia.22.04"
ENV ARGS="--name nvidiasmi"
LABEL oc.name="nvidia-smi"
LABEL oc.displayname="nvidia-smi"
...
ENV APPNAME "nvidia-smi"
ENV APPBIN "/usr/bin/konsole"
LABEL oc.args="--name nvidiasmi"
