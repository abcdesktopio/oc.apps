...
## JSON dump
json source file weather.d..json 
...
``` sh
ABCHOST=localhost
curl --output weather.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/weather.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @weather.d..json
...
# Dockerfile weather is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f weather.d -t weather .
```
