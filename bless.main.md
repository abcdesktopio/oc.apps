...
## JSON dump
json source file bless.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output bless.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/bless.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @bless.d.main.json
...
# Dockerfile Bless is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Bless.d -t Bless .
```
