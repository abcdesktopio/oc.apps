...
## JSON dump
json source file hyper.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output hyper.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/hyper.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @hyper.d.main.json
...
# Dockerfile hyper is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64,linux/arm64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f hyper.d -t hyper .
```
