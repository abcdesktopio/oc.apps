...
## JSON dump
json source file apachedirectorystudio.d..json 
...
``` sh
ABCHOST=localhost
curl --output apachedirectorystudio.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/apachedirectorystudio.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @apachedirectorystudio.d..json
...
# Dockerfile apachedirectorystudio is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f apachedirectorystudio.d -t apachedirectorystudio .
```
