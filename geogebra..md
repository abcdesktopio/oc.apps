...
## JSON dump
json source file geogebra.d..json 
...
``` sh
ABCHOST=localhost
curl --output geogebra.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/geogebra.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @geogebra.d..json
...
# Dockerfile Geogebra is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Geogebra.d -t Geogebra .
```
