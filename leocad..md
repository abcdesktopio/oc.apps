...
## JSON dump
json source file leocad.d..json 
...
``` sh
ABCHOST=localhost
curl --output leocad.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/leocad.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @leocad.d..json
...
# Dockerfile Leocad is generated at Thu Mar 28 2024 10:54:49 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Leocad.d -t Leocad .
```
