...
## JSON dump
json source file robots.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output robots.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/robots.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @robots.d.main.json
...
# Dockerfile Robots is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Robots.d -t Robots .
```
