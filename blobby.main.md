...
## JSON dump
json source file blobby.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output blobby.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/blobby.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @blobby.d.main.json
...
# Dockerfile blobby is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f blobby.d -t blobby .
```
