...
## JSON dump
json source file kturtle.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output kturtle.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kturtle.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kturtle.d.main.json
...
# Dockerfile kTurtle is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f kTurtle.d -t kTurtle .
```
