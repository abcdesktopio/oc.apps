...
## JSON dump
json source file mongodb-compass.d..json 
...
``` sh
ABCHOST=localhost
curl --output mongodb-compass.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mongodb-compass.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mongodb-compass.d..json
...
# Dockerfile mongodb-compass is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f mongodb-compass.d -t mongodb-compass .
```
