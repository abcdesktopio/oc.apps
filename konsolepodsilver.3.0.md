...
## JSON dump
json source file konsolepodsilver.d.3.0.json 
...
``` sh
ABCHOST=localhost
curl --output konsolepodsilver.d.3.0.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodsilver.d.3.0.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodsilver.d.3.0.json
...
# Dockerfile konsolepodsilver is generated at Mon Sep 18 2023 08:19:36 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=3.0 -f konsolepodsilver.d -t konsolepodsilver .
```
