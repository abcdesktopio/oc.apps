...
``` sh
ABCHOST=localhost
curl --output bless.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/bless.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @bless.d..json
...
# Dockerfile Bless is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Bless.d -t Bless .
```
