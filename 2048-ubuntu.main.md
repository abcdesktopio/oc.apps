...
## JSON dump
json source file 2048-ubuntu.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output 2048-ubuntu.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-ubuntu.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @2048-ubuntu.d.main.json
...
# Dockerfile 2048-ubuntu is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f 2048-ubuntu.d -t 2048-ubuntu .
```
