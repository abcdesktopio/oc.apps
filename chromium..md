...
## JSON dump
json source file chromium.d..json 
...
``` sh
ABCHOST=localhost
curl --output chromium.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chromium.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chromium.d..json
...
# Dockerfile chromium is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f chromium.d -t chromium .
```
