...
## JSON dump
json source file shotcut.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output shotcut.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/shotcut.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @shotcut.d.main.json
...
# Dockerfile Shotcut is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f Shotcut.d -t Shotcut .
```
