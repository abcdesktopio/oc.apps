...
## JSON dump
json source file thunderbird.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output thunderbird.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/thunderbird.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @thunderbird.d.main.json
...
# Dockerfile thunderbird is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f thunderbird.d -t thunderbird .
```
