...
## JSON dump
json source file frozen-bubble.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output frozen-bubble.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/frozen-bubble.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @frozen-bubble.d.main.json
...
# Dockerfile frozen-bubble is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f frozen-bubble.d -t frozen-bubble .
```
