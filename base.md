...
## JSON dump
json source file base.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output base.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/base.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @base.d.main.json
...
# Dockerfile base is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f base.d -t base .
```
