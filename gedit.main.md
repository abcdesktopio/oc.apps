...
## JSON dump
json source file gedit.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output gedit.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gedit.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gedit.d.main.json
...
# Dockerfile Gedit is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Gedit.d -t Gedit .
```
