...
## JSON dump
json source file mahjongg.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output mahjongg.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mahjongg.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mahjongg.d.main.json
...
# Dockerfile mahjongg is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f mahjongg.d -t mahjongg .
```
