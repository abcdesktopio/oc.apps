...
## JSON dump
json source file whatsdesk.d..json 
...
``` sh
ABCHOST=localhost
curl --output whatsdesk.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/whatsdesk.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @whatsdesk.d..json
...
# Dockerfile whatsdesk is generated at Thu Mar 28 2024 15:14:04 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f whatsdesk.d -t whatsdesk .
```
