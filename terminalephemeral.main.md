...
## JSON dump
json source file terminalephemeral.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output terminalephemeral.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/terminalephemeral.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @terminalephemeral.d.main.json
...
# Dockerfile terminalephemeral is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f terminalephemeral.d -t terminalephemeral .
```
