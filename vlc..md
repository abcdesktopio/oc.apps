...
``` sh
ABCHOST=localhost
curl --output vlc.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/vlc.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @vlc.d..json
...
# Dockerfile vlc is generated at Thu Mar 28 2024 10:54:49 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f vlc.d -t vlc .
```
