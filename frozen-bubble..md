...
## JSON dump
json source file frozen-bubble.d..json 
...
``` sh
ABCHOST=localhost
curl --output frozen-bubble.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/frozen-bubble.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @frozen-bubble.d..json
...
# Dockerfile frozen-bubble is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f frozen-bubble.d -t frozen-bubble .
```
