...
## JSON dump
json source file winscp-wine.d..json 
...
``` sh
ABCHOST=localhost
curl --output winscp-wine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winscp-wine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winscp-wine.d..json
...
# Dockerfile winscp-wine is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f winscp-wine.d -t winscp-wine .
```
