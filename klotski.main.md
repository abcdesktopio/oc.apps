...
## JSON dump
json source file klotski.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output klotski.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/klotski.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @klotski.d.main.json
...
# Dockerfile klotski is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f klotski.d -t klotski .
```
