...
## JSON dump
json source file chrome.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output chrome.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chrome.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chrome.d.main.json
...
# Dockerfile chrome is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f chrome.d -t chrome .
```
