...
## JSON dump
json source file inkscape.d.main.json 
...
``` json
{
    ...
    "cat": "graphics",
    "apkpackage": "inkscape inkscape-lang",
...
``` sh
ABCHOST=localhost
curl --output inkscape.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/inkscape.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @inkscape.d.main.json
...
# Dockerfile inkscape is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f inkscape.d -t inkscape .
```
