...
## JSON dump
json source file evolution.d..json 
...
``` sh
ABCHOST=localhost
curl --output evolution.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/evolution.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @evolution.d..json
...
# Dockerfile evolution is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f evolution.d -t evolution .
```
