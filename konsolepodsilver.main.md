# konsolepodsilver
![konsolesilver.svg](icons/konsolesilver.svg){: style="height:64px;width:64px"}
## inherite from
...
## JSON dump
json source file konsolepodsilver.d.main.json 
...
``` json
{
    ...
    "icon": "konsolesilver.svg",
    "apkpackage": "konsole sudo",
    "keyword": "ksonsole,console,shell,bash,sh,pod",
    "launch": "podsilver.konsole",
    "name": "konsolepodsilver",
    "displayname": "konsole silver [pod]",
...
``` sh
ABCHOST=localhost
curl --output konsolepodsilver.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodsilver.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodsilver.d.main.json
...
# Dockerfile konsolepodsilver is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
[Dockerfile for application konsolepodsilver](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodsilver.d)
``` sh
wget https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodsilver.d
```

### build the `Dockerfile` to create a container image

``` sh
docker build --build-arg TAG=main -f konsolepodsilver.d -t konsolepodsilver .
```
...
``` sh
ABCHOST=localhost
docker inspect konsolepodsilver > konsolepodsilver.json
docker image save konsolepodsilver -o konsolepodsilver.tar
ctr -n k8s.io images import konsolepodsilver.tar
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodsilver.json
