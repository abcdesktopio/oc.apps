...
## inherite from
[abcdesktopio/oc.template.alpine.edge.gtk](../abcdesktopio/oc.template.alpine.edge.gtk)
## abcdesktop release
...
## JSON dump
json source file shotcut.d..json 
...
``` json
{
    ...
    "template": "abcdesktopio/oc.template.alpine.edge.gtk",
...
``` sh
ABCHOST=localhost
curl --output shotcut.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/shotcut.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @shotcut.d..json
...
# Dockerfile Shotcut is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f Shotcut.d -t Shotcut .
```
