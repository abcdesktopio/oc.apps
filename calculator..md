...
## inherite from
[abcdesktopio/oc.template.alpine.edge](../abcdesktopio/oc.template.alpine.edge)
## abcdesktop release
...
## JSON dump
json source file calculator.d..json 
...
``` json
{
    ...
    "template": "abcdesktopio/oc.template.alpine.edge",
...
``` sh
ABCHOST=localhost
curl --output calculator.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/calculator.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @calculator.d..json
...
# Dockerfile calculator is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f calculator.d -t calculator .
```
