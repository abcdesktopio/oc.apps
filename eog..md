...
``` sh
ABCHOST=localhost
curl --output eog.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/eog.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @eog.d..json
...
# Dockerfile eog is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f eog.d -t eog .
```
