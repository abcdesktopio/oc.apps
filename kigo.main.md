...
## JSON dump
json source file kigo.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output kigo.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kigo.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kigo.d.main.json
...
# Dockerfile kigo is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f kigo.d -t kigo .
```
