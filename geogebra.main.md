...
## JSON dump
json source file geogebra.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output geogebra.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/geogebra.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @geogebra.d.main.json
...
# Dockerfile Geogebra is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Geogebra.d -t Geogebra .
```
