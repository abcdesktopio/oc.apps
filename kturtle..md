...
## JSON dump
json source file kturtle.d..json 
...
``` sh
ABCHOST=localhost
curl --output kturtle.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kturtle.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kturtle.d..json
...
# Dockerfile kTurtle is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f kTurtle.d -t kTurtle .
```
