...
## JSON dump
json source file qterminalpod.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output qterminalpod.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/qterminalpod.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @qterminalpod.d.main.json
...
# Dockerfile qterminalpod is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f qterminalpod.d -t qterminalpod .
```
