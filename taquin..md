...
## JSON dump
json source file taquin.d..json 
...
``` sh
ABCHOST=localhost
curl --output taquin.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/taquin.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @taquin.d..json
...
# Dockerfile taquin is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f taquin.d -t taquin .
```
