...
## JSON dump
json source file putty-wine.d..json 
...
``` sh
ABCHOST=localhost
curl --output putty-wine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/putty-wine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @putty-wine.d..json
...
# Dockerfile putty-wine is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f putty-wine.d -t putty-wine .
```
