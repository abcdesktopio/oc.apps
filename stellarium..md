...
## JSON dump
json source file stellarium.d..json 
...
``` sh
ABCHOST=localhost
curl --output stellarium.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/stellarium.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @stellarium.d..json
...
# Dockerfile Stellarium is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Stellarium.d -t Stellarium .
```
