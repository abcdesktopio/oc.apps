...
## JSON dump
json source file xedit.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output xedit.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xedit.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xedit.d.main.json
...
# Dockerfile xedit is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f xedit.d -t xedit .
```
