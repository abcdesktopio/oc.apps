...
## JSON dump
json source file chess.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output chess.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chess.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chess.d.main.json
...
# Dockerfile chess is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f chess.d -t chess .
```
