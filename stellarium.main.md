...
## JSON dump
json source file stellarium.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output stellarium.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/stellarium.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @stellarium.d.main.json
...
# Dockerfile Stellarium is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Stellarium.d -t Stellarium .
```
