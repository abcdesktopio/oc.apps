...
``` sh
ABCHOST=localhost
curl --output xpad.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xpad.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xpad.d..json
...
# Dockerfile xpad is generated at Thu Mar 28 2024 15:14:04 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f xpad.d -t xpad .
```
