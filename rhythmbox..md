...
## JSON dump
json source file rhythmbox.d..json 
...
``` sh
ABCHOST=localhost
curl --output rhythmbox.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/rhythmbox.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @rhythmbox.d..json
...
# Dockerfile rhythmbox is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f rhythmbox.d -t rhythmbox .
```
