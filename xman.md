...
## JSON dump
json source file xman.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output xman.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xman.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xman.d.main.json
...
# Dockerfile xman is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f xman.d -t xman .
```
