...
## JSON dump
json source file minecraft.d..json 
...
``` sh
ABCHOST=localhost
curl --output minecraft.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/minecraft.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @minecraft.d..json
...
# Dockerfile minecraft is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f minecraft.d -t minecraft .
```
