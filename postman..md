...
## JSON dump
json source file postman.d..json 
...
``` sh
ABCHOST=localhost
curl --output postman.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/postman.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @postman.d..json
...
# Dockerfile postman is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f postman.d -t postman .
```
