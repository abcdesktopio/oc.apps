...
## JSON dump
json source file 2048-alpine.d..json 
...
``` sh
ABCHOST=localhost
curl --output 2048-alpine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-alpine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @2048-alpine.d..json
...
# Dockerfile 2048-alpine is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f 2048-alpine.d -t 2048-alpine .
```
