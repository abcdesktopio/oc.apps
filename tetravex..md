...
## JSON dump
json source file tetravex.d..json 
...
``` sh
ABCHOST=localhost
curl --output tetravex.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/tetravex.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @tetravex.d..json
...
# Dockerfile Tetravex is generated at Thu Mar 28 2024 15:14:04 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Tetravex.d -t Tetravex .
```
