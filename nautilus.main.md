...
## JSON dump
json source file nautilus.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output nautilus.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/nautilus.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @nautilus.d.main.json
...
# Dockerfile nautilus is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f nautilus.d -t nautilus .
```
