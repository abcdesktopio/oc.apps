...
## JSON dump
json source file vice.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output vice.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/vice.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @vice.d.main.json
...
# Dockerfile vice is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f vice.d -t vice .
```
