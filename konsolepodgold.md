...
## JSON dump
json source file konsolepodgold.d.3.0.json 
...
``` sh
ABCHOST=localhost
curl --output konsolepodgold.d.3.0.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodgold.d.3.0.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodgold.d.3.0.json
...
# Dockerfile konsolepodgold is generated at Sat Jun 24 2023 11:31:12 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=3.0 -f konsolepodgold.d -t konsolepodgold .
```
