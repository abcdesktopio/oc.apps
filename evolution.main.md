...
## JSON dump
json source file evolution.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output evolution.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/evolution.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @evolution.d.main.json
...
# Dockerfile evolution is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f evolution.d -t evolution .
```
