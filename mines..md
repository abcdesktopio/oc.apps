...
``` sh
ABCHOST=localhost
curl --output mines.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mines.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mines.d..json
...
# Dockerfile Mines is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Mines.d -t Mines .
```
