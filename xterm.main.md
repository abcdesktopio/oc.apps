...
## JSON dump
json source file xterm.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output xterm.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xterm.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xterm.d.main.json
...
# Dockerfile xterm is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f xterm.d -t xterm .
```
