...
## JSON dump
json source file nautilus.d..json 
...
``` sh
ABCHOST=localhost
curl --output nautilus.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/nautilus.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @nautilus.d..json
...
# Dockerfile nautilus is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f nautilus.d -t nautilus .
```
