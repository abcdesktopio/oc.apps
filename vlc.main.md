...
## JSON dump
json source file vlc.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output vlc.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/vlc.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @vlc.d.main.json
...
# Dockerfile vlc is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f vlc.d -t vlc .
```
