...
## JSON dump
json source file konsolepodgold.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output konsolepodgold.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodgold.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodgold.d.main.json
...
# Dockerfile konsolepodgold is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f konsolepodgold.d -t konsolepodgold .
```
