...
## JSON dump
json source file planner.d..json 
...
``` sh
ABCHOST=localhost
curl --output planner.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/planner.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @planner.d..json
...
# Dockerfile Planner is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Planner.d -t Planner .
```
