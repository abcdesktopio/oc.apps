...
## JSON dump
json source file apachedirectorystudio.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output apachedirectorystudio.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/apachedirectorystudio.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @apachedirectorystudio.d.main.json
...
# Dockerfile apachedirectorystudio is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f apachedirectorystudio.d -t apachedirectorystudio .
```
