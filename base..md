...
``` sh
ABCHOST=localhost
curl --output base.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/base.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @base.d..json
...
# Dockerfile base is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f base.d -t base .
```
