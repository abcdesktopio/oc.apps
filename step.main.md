...
## JSON dump
json source file step.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output step.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/step.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @step.d.main.json
...
# Dockerfile Step is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Step.d -t Step .
```
