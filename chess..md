...
``` sh
ABCHOST=localhost
curl --output chess.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chess.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chess.d..json
...
# Dockerfile chess is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f chess.d -t chess .
```
