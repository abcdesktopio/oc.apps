...
## JSON dump
json source file weather.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output weather.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/weather.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @weather.d.main.json
...
# Dockerfile weather is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f weather.d -t weather .
```
