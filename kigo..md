...
``` sh
ABCHOST=localhost
curl --output kigo.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kigo.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kigo.d..json
...
# Dockerfile kigo is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f kigo.d -t kigo .
```
