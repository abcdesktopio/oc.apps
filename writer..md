...
## JSON dump
json source file writer.d..json 
...
``` sh
ABCHOST=localhost
curl --output writer.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/writer.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @writer.d..json
...
# Dockerfile writer is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f writer.d -t writer .
```
