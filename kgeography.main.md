...
## JSON dump
json source file kgeography.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output kgeography.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kgeography.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kgeography.d.main.json
...
# Dockerfile Kgeography is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Kgeography.d -t Kgeography .
```
