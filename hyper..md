...
``` sh
ABCHOST=localhost
curl --output hyper.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/hyper.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @hyper.d..json
...
# Dockerfile hyper is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64,linux/arm64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f hyper.d -t hyper .
```
