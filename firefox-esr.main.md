...
## JSON dump
json source file firefox-esr.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output firefox-esr.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/firefox-esr.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @firefox-esr.d.main.json
...
# Dockerfile firefox-esr is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f firefox-esr.d -t firefox-esr .
```
