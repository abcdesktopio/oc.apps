...
## JSON dump
json source file evince.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output evince.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/evince.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @evince.d.main.json
...
# Dockerfile Evince is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Evince.d -t Evince .
```
