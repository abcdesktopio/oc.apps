...
## JSON dump
json source file putty-unix.d..json 
...
``` sh
ABCHOST=localhost
curl --output putty-unix.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/putty-unix.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @putty-unix.d..json
...
# Dockerfile putty-unix is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f putty-unix.d -t putty-unix .
```
