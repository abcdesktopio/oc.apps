...
## JSON dump
json source file notepadqq.d..json 
...
``` sh
ABCHOST=localhost
curl --output notepadqq.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/notepadqq.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @notepadqq.d..json
...
# Dockerfile notepadqq is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f notepadqq.d -t notepadqq .
```
