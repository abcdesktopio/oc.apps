...
## JSON dump
json source file remmina.d..json 
...
``` sh
ABCHOST=localhost
curl --output remmina.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/remmina.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @remmina.d..json
...
# Dockerfile remmina is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f remmina.d -t remmina .
```
