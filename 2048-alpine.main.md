...
``` 
mesa-gl mesa-dri-gallium gnome-2048
```
...
## JSON dump
json source file 2048-alpine.d.main.json 
...
``` json
{
    ...
    "apkpackage": "mesa-gl mesa-dri-gallium gnome-2048",
...
``` sh
ABCHOST=localhost
curl --output 2048-alpine.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-alpine.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @2048-alpine.d.main.json
...
# Dockerfile 2048-alpine is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f 2048-alpine.d -t 2048-alpine .
```
