...
``` sh
ABCHOST=localhost
curl --output xeyes.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xeyes.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xeyes.d..json
...
# Dockerfile xeyes is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f xeyes.d -t xeyes .
```
