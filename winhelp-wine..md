...
## JSON dump
json source file winhelp-wine.d..json 
...
``` sh
ABCHOST=localhost
curl --output winhelp-wine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winhelp-wine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winhelp-wine.d..json
...
# Dockerfile winhelp-wine is generated at Thu Mar 28 2024 10:54:49 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f winhelp-wine.d -t winhelp-wine .
```
