...
## JSON dump
json source file konsolepod.d.3.0.json 
...
``` sh
ABCHOST=localhost
curl --output konsolepod.d.3.0.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepod.d.3.0.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepod.d.3.0.json
...
# Dockerfile konsolepod is generated at Thu Jun 29 2023 14:48:04 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=3.0 -f konsolepod.d -t konsolepod .
```
