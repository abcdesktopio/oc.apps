...
## JSON dump
json source file wireshark.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output wireshark.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/wireshark.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @wireshark.d.main.json
...
# Dockerfile wireshark is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f wireshark.d -t wireshark .
```
