...
## JSON dump
json source file mahjongg.d..json 
...
``` sh
ABCHOST=localhost
curl --output mahjongg.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mahjongg.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mahjongg.d..json
...
# Dockerfile mahjongg is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f mahjongg.d -t mahjongg .
```
