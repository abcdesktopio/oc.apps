...
## JSON dump
json source file konsolephemeralcontainer.d.3.0.json 
...
``` sh
ABCHOST=localhost
curl --output konsolephemeralcontainer.d.3.0.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolephemeralcontainer.d.3.0.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolephemeralcontainer.d.3.0.json
...
# Dockerfile konsolephemeralcontainer is generated at Thu Aug 10 2023 13:08:21 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=3.0 -f konsolephemeralcontainer.d -t konsolephemeralcontainer .
```
