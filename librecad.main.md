...
## JSON dump
json source file librecad.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output librecad.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/librecad.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @librecad.d.main.json
...
# Dockerfile LibreCAD is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f LibreCAD.d -t LibreCAD .
```
