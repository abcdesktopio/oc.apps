...
``` sh
ABCHOST=localhost
curl --output gedit.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gedit.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gedit.d..json
...
# Dockerfile Gedit is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Gedit.d -t Gedit .
```
