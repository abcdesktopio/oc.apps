...
## JSON dump
json source file mines.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output mines.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mines.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mines.d.main.json
...
# Dockerfile Mines is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Mines.d -t Mines .
```
