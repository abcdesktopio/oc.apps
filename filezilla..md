...
## JSON dump
json source file filezilla.d..json 
...
``` sh
ABCHOST=localhost
curl --output filezilla.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/filezilla.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @filezilla.d..json
...
# Dockerfile filezilla is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f filezilla.d -t filezilla .
```
