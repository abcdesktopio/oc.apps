...
## JSON dump
json source file math.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output math.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/math.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @math.d.main.json
...
# Dockerfile math is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f math.d -t math .
```
