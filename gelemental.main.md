...
## JSON dump
json source file gelemental.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output gelemental.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gelemental.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gelemental.d.main.json
...
# Dockerfile gElemental is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f gElemental.d -t gElemental .
```
