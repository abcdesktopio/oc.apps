...
## JSON dump
json source file firefox.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output firefox.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/firefox.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @firefox.d.main.json
...
# Dockerfile Firefox is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Firefox.d -t Firefox .
```
