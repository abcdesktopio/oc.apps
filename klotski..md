...
## JSON dump
json source file klotski.d..json 
...
``` sh
ABCHOST=localhost
curl --output klotski.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/klotski.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @klotski.d..json
...
# Dockerfile klotski is generated at Thu Mar 28 2024 15:14:04 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f klotski.d -t klotski .
```
