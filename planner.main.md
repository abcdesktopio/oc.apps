...
## JSON dump
json source file planner.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output planner.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/planner.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @planner.d.main.json
...
# Dockerfile Planner is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Planner.d -t Planner .
```
