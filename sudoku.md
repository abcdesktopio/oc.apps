...
## JSON dump
json source file sudoku.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output sudoku.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sudoku.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @sudoku.d.main.json
...
# Dockerfile sudoku is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f sudoku.d -t sudoku .
```
