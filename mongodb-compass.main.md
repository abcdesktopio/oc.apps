...
## JSON dump
json source file mongodb-compass.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output mongodb-compass.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/mongodb-compass.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @mongodb-compass.d.main.json
...
# Dockerfile mongodb-compass is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f mongodb-compass.d -t mongodb-compass .
```
