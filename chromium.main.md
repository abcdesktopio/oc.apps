...
## JSON dump
json source file chromium.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output chromium.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chromium.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chromium.d.main.json
...
# Dockerfile chromium is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f chromium.d -t chromium .
```
