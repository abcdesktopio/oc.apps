...
## JSON dump
json source file tetravex.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output tetravex.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/tetravex.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @tetravex.d.main.json
...
# Dockerfile Tetravex is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Tetravex.d -t Tetravex .
```
