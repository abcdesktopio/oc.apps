...
``` sh
ABCHOST=localhost
curl --output golly.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/golly.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @golly.d..json
...
# Dockerfile Golly is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Golly.d -t Golly .
```
