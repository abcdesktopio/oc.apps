...
## JSON dump
json source file astromenace.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output astromenace.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/astromenace.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @astromenace.d.main.json
...
# Dockerfile astromenace is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f astromenace.d -t astromenace .
```
