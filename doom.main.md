...
## JSON dump
json source file doom.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output doom.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/doom.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @doom.d.main.json
...
# Dockerfile doom is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f doom.d -t doom .
```
