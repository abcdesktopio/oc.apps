...
## JSON dump
json source file xeyes.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output xeyes.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xeyes.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xeyes.d.main.json
...
# Dockerfile xeyes is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f xeyes.d -t xeyes .
```
