...
## JSON dump
json source file calculator.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output calculator.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/calculator.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @calculator.d.main.json
...
# Dockerfile calculator is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f calculator.d -t calculator .
```
