...
## JSON dump
json source file winefile-wine.d..json 
...
``` sh
ABCHOST=localhost
curl --output winefile-wine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winefile-wine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winefile-wine.d..json
...
# Dockerfile winefile-wine is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f winefile-wine.d -t winefile-wine .
```
