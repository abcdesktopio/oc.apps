...
## JSON dump
json source file taquin.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output taquin.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/taquin.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @taquin.d.main.json
...
# Dockerfile taquin is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f taquin.d -t taquin .
```
