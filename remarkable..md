...
## JSON dump
json source file remarkable.d..json 
...
``` sh
ABCHOST=localhost
curl --output remarkable.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/remarkable.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @remarkable.d..json
...
# Dockerfile remarkable is generated at Thu Mar 28 2024 10:54:49 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f remarkable.d -t remarkable .
```
