...
## JSON dump
json source file winemine-wine.d..json 
...
``` sh
ABCHOST=localhost
curl --output winemine-wine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winemine-wine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winemine-wine.d..json
...
# Dockerfile winemine-wine is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f winemine-wine.d -t winemine-wine .
```
