...
## JSON dump
json source file boxes.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output boxes.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/boxes.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @boxes.d.main.json
...
# Dockerfile boxes is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f boxes.d -t boxes .
```
