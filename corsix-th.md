...
## JSON dump
json source file corsix-th.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output corsix-th.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/corsix-th.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @corsix-th.d.main.json
...
# Dockerfile corsix-th is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f corsix-th.d -t corsix-th .
```
