...
``` sh
ABCHOST=localhost
curl --output boxes.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/boxes.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @boxes.d..json
...
# Dockerfile boxes is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f boxes.d -t boxes .
```
