...
## JSON dump
json source file chrome.d..json 
...
``` sh
ABCHOST=localhost
curl --output chrome.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chrome.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @chrome.d..json
...
# Dockerfile chrome is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f chrome.d -t chrome .
```
