...
## JSON dump
json source file inkscape.d..json 
...
``` sh
ABCHOST=localhost
curl --output inkscape.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/inkscape.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @inkscape.d..json
...
# Dockerfile inkscape is generated at Wed Jan 31 2024 16:43:09 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f inkscape.d -t inkscape .
```
