...
## JSON dump
json source file writer.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output writer.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/writer.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @writer.d.main.json
...
# Dockerfile writer is generated at Thu Aug 03 2023 08:38:51 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f writer.d -t writer .
```
