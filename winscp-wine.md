...
## JSON dump
json source file winscp-wine.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output winscp-wine.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winscp-wine.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winscp-wine.d.main.json
...
# Dockerfile winscp-wine is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f winscp-wine.d -t winscp-wine .
```
