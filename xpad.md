...
## JSON dump
json source file xpad.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output xpad.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xpad.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @xpad.d.main.json
...
# Dockerfile xpad is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f xpad.d -t xpad .
```
