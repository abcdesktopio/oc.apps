...
## JSON dump
json source file robots.d..json 
...
``` sh
ABCHOST=localhost
curl --output robots.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/robots.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @robots.d..json
...
# Dockerfile Robots is generated at Thu Mar 28 2024 15:35:00 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Robots.d -t Robots .
```
