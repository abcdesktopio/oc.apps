...
## JSON dump
json source file golly.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output golly.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/golly.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @golly.d.main.json
...
# Dockerfile Golly is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Golly.d -t Golly .
```
