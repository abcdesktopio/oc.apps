...
## JSON dump
json source file rhythmbox.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output rhythmbox.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/rhythmbox.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @rhythmbox.d.main.json
...
# Dockerfile rhythmbox is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f rhythmbox.d -t rhythmbox .
```
