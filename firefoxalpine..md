...
## JSON dump
json source file firefoxalpine.d..json 
...
``` sh
ABCHOST=localhost
curl --output firefoxalpine.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/firefoxalpine.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @firefoxalpine.d..json
...
# Dockerfile FirefoxAlpine is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f FirefoxAlpine.d -t FirefoxAlpine .
```
