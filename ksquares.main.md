...
## JSON dump
json source file ksquares.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output ksquares.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/ksquares.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @ksquares.d.main.json
...
# Dockerfile kSquares is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f kSquares.d -t kSquares .
```
