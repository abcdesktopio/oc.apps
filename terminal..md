...
## JSON dump
json source file terminal.d..json 
...
``` sh
ABCHOST=localhost
curl --output terminal.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/terminal.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @terminal.d..json
...
# Dockerfile Terminal is generated at Mon Sep 18 2023 09:33:18 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Terminal.d -t Terminal .
```
