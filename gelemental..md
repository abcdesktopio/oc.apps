...
## JSON dump
json source file gelemental.d..json 
...
``` sh
ABCHOST=localhost
curl --output gelemental.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gelemental.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @gelemental.d..json
...
# Dockerfile gElemental is generated at Wed Jan 31 2024 16:43:09 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f gElemental.d -t gElemental .
```
