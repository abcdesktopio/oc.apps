...
## JSON dump
json source file supertux2.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output supertux2.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/supertux2.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @supertux2.d.main.json
...
# Dockerfile supertux2 is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f supertux2.d -t supertux2 .
```
