...
## JSON dump
json source file konsolepodbronze.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output konsolepodbronze.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepodbronze.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepodbronze.d.main.json
...
# Dockerfile konsolepodbronze is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f konsolepodbronze.d -t konsolepodbronze .
```
