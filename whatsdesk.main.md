...
## JSON dump
json source file whatsdesk.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output whatsdesk.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/whatsdesk.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @whatsdesk.d.main.json
...
# Dockerfile whatsdesk is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f whatsdesk.d -t whatsdesk .
```
