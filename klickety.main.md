...
## JSON dump
json source file klickety.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output klickety.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/klickety.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @klickety.d.main.json
...
# Dockerfile Klickety is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f Klickety.d -t Klickety .
```
