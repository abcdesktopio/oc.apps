...
``` sh
ABCHOST=localhost
curl --output draw.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/draw.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @draw.d..json
...
# Dockerfile draw is generated at Fri Feb 02 2024 14:47:39 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f draw.d -t draw .
```
