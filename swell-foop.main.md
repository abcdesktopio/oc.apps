...
## JSON dump
json source file swell-foop.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output swell-foop.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/swell-foop.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @swell-foop.d.main.json
...
# Dockerfile swell-foop is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f swell-foop.d -t swell-foop .
```
