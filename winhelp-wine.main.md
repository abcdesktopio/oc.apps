...
## JSON dump
json source file winhelp-wine.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output winhelp-wine.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winhelp-wine.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @winhelp-wine.d.main.json
...
# Dockerfile winhelp-wine is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f winhelp-wine.d -t winhelp-wine .
```
