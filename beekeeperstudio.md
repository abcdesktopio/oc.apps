...
## JSON dump
json source file beekeeperstudio.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output beekeeperstudio.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/beekeeperstudio.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @beekeeperstudio.d.main.json
...
# Dockerfile beekeeperstudio is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f beekeeperstudio.d -t beekeeperstudio .
```
