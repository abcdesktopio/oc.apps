...
## JSON dump
json source file supertux2.d..json 
...
``` sh
ABCHOST=localhost
curl --output supertux2.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/supertux2.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @supertux2.d..json
...
# Dockerfile supertux2 is generated at Thu Mar 28 2024 15:35:00 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f supertux2.d -t supertux2 .
```
