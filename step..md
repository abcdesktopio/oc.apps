...
``` sh
ABCHOST=localhost
curl --output step.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/step.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @step.d..json
...
# Dockerfile Step is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Step.d -t Step .
```
