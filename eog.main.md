...
## JSON dump
json source file eog.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output eog.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/eog.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @eog.d.main.json
...
# Dockerfile eog is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f eog.d -t eog .
```
