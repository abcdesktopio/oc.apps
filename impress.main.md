...
## JSON dump
json source file impress.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output impress.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/impress.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @impress.d.main.json
...
# Dockerfile impress is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f impress.d -t impress .
```
