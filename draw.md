...
## JSON dump
json source file draw.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output draw.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/draw.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @draw.d.main.json
...
# Dockerfile draw is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f draw.d -t draw .
```
