...
## JSON dump
json source file blender.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output blender.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/blender.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @blender.d.main.json
...
# Dockerfile blender is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f blender.d -t blender .
```
