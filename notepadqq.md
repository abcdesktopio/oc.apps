...
## JSON dump
json source file notepadqq.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output notepadqq.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/notepadqq.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @notepadqq.d.main.json
...
# Dockerfile notepadqq is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f notepadqq.d -t notepadqq .
```
