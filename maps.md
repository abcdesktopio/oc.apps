...
## JSON dump
json source file maps.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output maps.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/maps.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @maps.d.main.json
...
# Dockerfile maps is generated at Wed Aug 02 2023 12:39:17 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f maps.d -t maps .
```
