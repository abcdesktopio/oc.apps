...
## JSON dump
json source file konsolepod.d..json 
...
``` sh
ABCHOST=localhost
curl --output konsolepod.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsolepod.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @konsolepod.d..json
...
# Dockerfile konsolepod is generated at Thu Dec 28 2023 15:55:23 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f konsolepod.d -t konsolepod .
```
