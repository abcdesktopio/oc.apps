...
## JSON dump
json source file putty-unix.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output putty-unix.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/putty-unix.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @putty-unix.d.main.json
...
# Dockerfile putty-unix is generated at Thu Feb 01 2024 17:18:58 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f putty-unix.d -t putty-unix .
```
