...
## JSON dump
json source file edge.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output edge.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/edge.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @edge.d.main.json
...
# Dockerfile edge is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG=main -f edge.d -t edge .
```
