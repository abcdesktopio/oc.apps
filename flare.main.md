...
## JSON dump
json source file flare.d.main.json 
...
``` sh
ABCHOST=localhost
curl --output flare.d.main.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/flare.d.main.json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @flare.d.main.json
...
# Dockerfile flare is generated at Thu Aug 10 2023 12:52:07 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG=main -f flare.d -t flare .
```
