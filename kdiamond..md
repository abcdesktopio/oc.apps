...
## JSON dump
json source file kdiamond.d..json 
...
``` json
{
    ...
    "apkpackage": "kdiamond dbus-x11",
    "icon": "kdiamond.svg",
    "keyword": "kdiamond",
    "launch": "kdiamond.kdiamond",
    "name": "kDiamond",
    "path": "/usr/bin/kdiamond",
...
``` sh
ABCHOST=localhost
curl --output kdiamond.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/kdiamond.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @kdiamond.d..json
...
# Dockerfile kDiamond is generated at Fri Feb 02 2024 16:33:40 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f kDiamond.d -t kDiamond .
```
