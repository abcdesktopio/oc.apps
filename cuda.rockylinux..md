...
# Dockerfile cuda.rockylinux is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
...
USER root
# Install package
RUN yum install -y gnome-terminal dbus-x11 mesa-dri-drivers mesa-libGL && yum -y clean all && rm -rf /var/cache
