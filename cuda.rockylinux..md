...
## Distributionockylinux ![rockylinux](icons/rockylinux.svg){: style="height:32px;"}
## RPM packages
...
``` json
{
    ...
    "cat": "development",
    "preruncommands": [],
    "rpmpackage": "gnome-terminal dbus-x11 mesa-dri-drivers mesa-libGL google-noto-fonts-common xorg-x11-fonts-100dpi xorg-x11-fonts-75dpi texlive-utopia liberation-fonts-common",
    "icon": "nvidia.svg",
    "keyword": "cuda nvidia rockylinux",
    "launch": "cudarockylinux.gnome-terminal",
    "name": "cuda.rockylinux",
    "path": "/usr/bin/gnome-terminal",
    "args": "-- /usr/bin/nvidia-smi",
    "rules": {
        "homedir": {
            "default": true
        }
...
# Dockerfile cuda.rockylinux is generated at Thu Mar 28 2024 21:36:18 GMT+0000 (Coordinated Universal Time)
...
USER root
# Install package
RUN yum install -y gnome-terminal dbus-x11 mesa-dri-drivers mesa-libGL google-noto-fonts-common xorg-x11-fonts-100dpi xorg-x11-fonts-75dpi texlive-utopia liberation-fonts-common && yum -y clean all && rm -rf /var/cache
...
LABEL oc.args="-- /usr/bin/nvidia-smi"
#
