...
## JSON dump
json source file impress.d..json 
...
``` sh
ABCHOST=localhost
curl --output impress.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/impress.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @impress.d..json
...
# Dockerfile impress is generated at Thu Mar 28 2024 20:47:16 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=dev
...
``` sh
docker build --build-arg TAG= -f impress.d -t impress .
```
