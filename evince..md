...
## JSON dump
json source file evince.d..json 
...
``` sh
ABCHOST=localhost
curl --output evince.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/evince.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @evince.d..json
...
# Dockerfile Evince is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f Evince.d -t Evince .
```
