...
## JSON dump
json source file beekeeperstudio.d..json 
...
``` sh
ABCHOST=localhost
curl --output beekeeperstudio.d..json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/beekeeperstudio.d..json
curl -X PUT -H 'Content-Type: text/javascript' http://$ABCHOST:30443/API/manager/image -d @beekeeperstudio.d..json
...
# Dockerfile beekeeperstudio is generated at Fri Dec 29 2023 17:15:56 GMT+0000 (Coordinated Universal Time)
...
``` sh
docker build --build-arg TAG= -f beekeeperstudio.d -t beekeeperstudio .
```
